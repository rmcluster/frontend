    ...
    <>
      ...
      {dragging && (
        <div
          ...
          aria-hidden="true"
        >
          <div className="text-[var(--accent)] text-lg font-semibold">Drop files to upload</div>
        </div>
      )}
          ...
          {uploading ? (
            ...
            <>
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                <path d="M7 2v8M4 5l3-3 3 3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />

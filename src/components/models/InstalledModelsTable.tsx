...
export function InstalledModelsTable({ models, loading }: InstalledModelsTableProps) {
  return (
    <div className="card">
              ...
              <tr>
                <td colSpan={6}>
                  <div className="empty-state" style={{ padding: 'var(--space-10) 0' }}>
                    ...
                    <p>Search Hugging Face above or upload a local .gguf file.</p>
                  </div>
                </td>
              </tr>
            ) : (
                ...
                <tr key={model.model}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                      <Link
                        to={`/chat?model=${encodeURIComponent(model.model)}`}
